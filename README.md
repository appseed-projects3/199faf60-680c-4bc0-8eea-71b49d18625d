...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-01 18:38`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/199faf60-680c-4bc0-8eea-71b49d18625d.git
$ cd 199faf60-680c-4bc0-8eea-71b49d18625d
```
